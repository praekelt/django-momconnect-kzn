...
DATABASES = {
    'default': dj_database_url.config(default='postgres:///momconnectkzn'),
}
...
SECRET_KEY = 'k#03gm2pqihky)#m-n8yz1j$qe^p=+yjr-&1txkheghqnoom_c'
...
ROOT_URLCONF = 'momconnectkzn.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'momconnectkzn.wsgi.application'
